// Lit v1 (lit-element 2.x) Settings Modal Component - TypeScript
import { LitElement, html, css, TemplateResult, property } from 'lit-element';

export class SettingsModalLitV1 extends LitElement {
...
customElements.define('settings-modal-lit-v1', SettingsModalLitV1);