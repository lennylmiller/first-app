...
export class AppNotifications extends LitElement {
  ...
  @state()
  private notifications: Notification[] = this.loadNotifications();
    ...
    return html`
      ...
      ${this.notifications.length > 0 ? html`
        <div class="notifications-footer">
          <a href="#" @click="${(e: Event) => { e.preventDefault(); this.viewAll(); }}">
  ...
  private handleAction(e: Event, action: NotificationAction): void {
    e.stopPropagation();
  ...
  private loadNotifications(): Notification[] {
    return storage.get('notifications', null) || [];
  }
  ...
  private addNotification(notification: Partial<Notification>): Notification {
