...
export class ThemeEditor extends LitElement {
  ...
  static properties = {
    currentTheme: { type: Object, state: true },
    customThemes: { type: Array, state: true },
    selectedPreset: { type: String, state: true },
    themeName: { type: String, state: true }
  };
  
  constructor() {
    super();
    this.currentTheme = this.getCurrentThemeColors();
    this.customThemes = storage.get('customThemes', []);
    this.selectedPreset = 'current';
    this.themeName = 'My Custom Theme';
      ...
      <div class="theme-editor">
        ...
        <div class="theme-name-section">
          <input 
            ...
            @input="${(e) => this.themeName = e.target.value}">
        </div>
      ...
      <div class="color-item">
        ...
        <div class="color-controls">
          <input 
            ...
            class="color-input"
            .value="${value}"
            @input="${(e) => this.updateColor(key, e.target.value)}">
