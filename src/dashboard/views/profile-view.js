          ...
          <form @submit="${this.handleSubmit}">
            <div class="form-group">
              ...
              <input 
                ...
                @input="${(e) => this.user = {...this.user, name: e.target.value}}">
            </div>
            ...
            <div class="form-group">
              ...
              <input 
                ...
                @input="${(e) => this.user = {...this.user, email: e.target.value}}">
            </div>
            ...
            <div class="form-group">
              ...
              <textarea 
                ...
                rows="4"
                .value="${this.user.bio}"
                @input="${(e) => this.user = {...this.user, bio: e.target.value}}"></textarea>
            </div>
