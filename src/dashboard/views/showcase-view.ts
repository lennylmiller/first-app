      ...
      <div class="container">
        ...
        <div class="features-grid">
          <div class="feature-card">
            ...
            <a href="/todos" class="feature-link" @click=${(e: Event) => {
              e.preventDefault();
          ...
          <div class="feature-card">
            ...
            <a href="/analytics" class="feature-link" @click=${(e: Event) => {
              e.preventDefault();
          ...
          <div class="feature-card">
            ...
            <a href="/widgets" class="feature-link" @click=${(e: Event) => {
              e.preventDefault();
          ...
          <div class="feature-card">
            ...
            <a href="/profile" class="feature-link" @click=${(e: Event) => {
              e.preventDefault();
          ...
          <div class="feature-card">
            ...
            <a href="/settings" class="feature-link" @click=${(e: Event) => {
              e.preventDefault();
